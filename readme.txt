...
* Copy SmartAccounts API key and secret from Merit interface. If you don't have Merit API key (please check Settings - Connected Services) you can contact Merit support to enable API service for your account. Additional conditions and charges may apply to API service.
...
= 3.0.0 =
Allows sending Woo orders to Merit as Offer.
